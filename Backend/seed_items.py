...
items = [
    ...
    {"name": "BenQ Short-Throw Projector", "category": "ELECTRONICS", "quantity": 4, "location": LOC_MEDIA_CENTER, "description": "Ultra short-throw for small rooms", "access_level": "STAFF", "borrow_duration": 8, "borrow_duration_unit": "HOURS", "months": 4},
    {"name": "Logitech Webcam C920", "category": "ELECTRONICS", "quantity": 20, "location": LOC_IT_STORAGE, "description": "HD webcam for online classes", "access_level": "STUDENT", "borrow_duration": 2, "borrow_duration_unit": "DAYS", "months": 4},
    ...
    {"name": "Canon DSLR Camera", "category": "ELECTRONICS", "quantity": 5, "location": LOC_MEDIA_CENTER, "description": "EOS Rebel T7 for photography class", "access_level": "FACULTY", "borrow_duration": 1, "borrow_duration_unit": "DAYS", "months": 3},
    {"name": "Sony Camcorder", "category": "ELECTRONICS", "quantity": 3, "location": LOC_MEDIA_CENTER, "description": "HD camcorder for video projects", "access_level": "FACULTY", "borrow_duration": 2, "borrow_duration_unit": "DAYS", "months": 3},
    ...
    {"name": "HDMI Cable (3m)", "category": "ELECTRONICS", "quantity": 25, "location": LOC_IT_STORAGE, "description": "Standard HDMI for projector connections", "access_level": "STUDENT", "is_returnable": True, "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 1},
    {"name": "VGA to HDMI Adapter", "category": "ELECTRONICS", "quantity": 10, "location": LOC_IT_STORAGE, "description": "Adapter for older laptops", "access_level": "STUDENT", "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 1},
    {"name": "USB-C Hub Multiport", "category": "ELECTRONICS", "quantity": 8, "location": LOC_IT_STORAGE, "description": "7-in-1 hub with HDMI, USB, SD card", "access_level": "STUDENT", "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 1},
    ...
    {"name": "Folding Table (6ft)", "category": "FURNITURE", "quantity": 30, "location": LOC_GYM_STORAGE, "description": "Rectangular folding table for events", "access_level": "STAFF", "borrow_duration": 1, "borrow_duration_unit": "DAYS", "months": 5},
    {"name": "Round Table (5ft)", "category": "FURNITURE", "quantity": 15, "location": LOC_GYM_STORAGE, "description": "Round banquet-style table", "access_level": "STAFF", "borrow_duration": 1, "borrow_duration_unit": "DAYS", "months": 4},
    ...
    {"name": "Podium / Lectern", "category": "FURNITURE", "quantity": 5, "location": LOC_ADMIN_BLDG, "description": "Wooden lectern with mic holder", "access_level": "FACULTY", "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 3},
    ...
    {"name": "Filing Cabinet (4-drawer)", "category": "FURNITURE", "quantity": 12, "location": LOC_ADMIN_BLDG, "description": "Steel filing cabinet for records", "access_level": "STAFF", "status": "IN_USE", "is_returnable": False, "months": 5},
    ...
    {"name": "Storage Cabinet (Metal)", "category": "FURNITURE", "quantity": 8, "location": LOC_FACULTY_ROOM, "description": "Lockable metal cabinet for department supplies", "access_level": "FACULTY", "status": "IN_USE", "is_returnable": False, "months": 3},
    {"name": "Collapsible Stage Platform", "category": "FURNITURE", "quantity": 6, "location": LOC_GYM_STORAGE, "description": "4x8 ft modular stage platform", "access_level": "STAFF", "borrow_duration": 1, "borrow_duration_unit": "DAYS", "months": 2},
    {"name": "Office Swivel Chair", "category": "FURNITURE", "quantity": 30, "location": LOC_ADMIN_BLDG, "description": "Ergonomic mesh-back office chair", "access_level": "STAFF", "status": "IN_USE", "is_returnable": False, "months": 5},
    ...
    {"name": "Basketball (Spalding)", "category": "EQUIPMENT", "quantity": 15, "location": LOC_PE_STORAGE, "description": "Official size 7 indoor/outdoor ball", "access_level": "STUDENT", "borrow_duration": 2, "borrow_duration_unit": "HOURS", "months": 5},
    {"name": "Volleyball (Mikasa)", "category": "EQUIPMENT", "quantity": 10, "location": LOC_PE_STORAGE, "description": "Official indoor volleyball", "access_level": "STUDENT", "borrow_duration": 2, "borrow_duration_unit": "HOURS", "months": 4},
    {"name": "Badminton Racket Set", "category": "EQUIPMENT", "quantity": 12, "location": LOC_PE_STORAGE, "description": "Set of 2 rackets with shuttlecocks", "access_level": "STUDENT", "borrow_duration": 2, "borrow_duration_unit": "HOURS", "months": 3},
    ...
    {"name": "Stopwatch Set (10 pcs)", "category": "EQUIPMENT", "quantity": 5, "location": LOC_PE_STORAGE, "description": "Digital stopwatch for PE activities", "access_level": "FACULTY", "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 1},
    {"name": "Measuring Tape (50m)", "category": "EQUIPMENT", "quantity": 6, "location": LOC_PE_STORAGE, "description": "Fiberglass measuring tape for fields", "access_level": "FACULTY", "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 0},
    {"name": "Laminating Machine", "category": "EQUIPMENT", "quantity": 2, "location": LOC_ADMIN_BLDG, "description": "A3 thermal laminator for IDs and posters", "access_level": "STAFF", "borrow_duration": 30, "borrow_duration_unit": "MINUTES", "months": 3},
    ...
    # ── SUPPLIES (20 items) ──
    {"name": "Whiteboard Marker Set", "category": "SUPPLIES", "quantity": 100, "location": LOC_FACULTY_ROOM, "description": "Pack of 4 colors (black, blue, red, green)", "access_level": "FACULTY", "is_returnable": False, "months": 5},
    {"name": "Chalk Box (White)", "category": "SUPPLIES", "quantity": 50, "location": LOC_FACULTY_ROOM, "description": "Box of 100 pcs dustless chalk", "access_level": "FACULTY", "is_returnable": False, "months": 5},
    {"name": "Bond Paper (A4 Ream)", "category": "SUPPLIES", "quantity": 80, "location": LOC_SUPPLY_ROOM, "description": "Substance 20, 500 sheets per ream", "access_level": "STAFF", "is_returnable": False, "months": 4},
    {"name": "Bond Paper (Legal Ream)", "category": "SUPPLIES", "quantity": 40, "location": LOC_SUPPLY_ROOM, "description": "Long/legal size, 500 sheets per ream", "access_level": "STAFF", "is_returnable": False, "months": 4},
    {"name": "Printer Ink (Black)", "category": "SUPPLIES", "quantity": 15, "location": LOC_IT_STORAGE, "description": "Compatible ink cartridge for Epson L-series", "access_level": "STAFF", "is_returnable": False, "months": 3},
    {"name": "Printer Ink (Colored Set)", "category": "SUPPLIES", "quantity": 10, "location": LOC_IT_STORAGE, "description": "Cyan, Magenta, Yellow set for Epson", "access_level": "STAFF", "is_returnable": False, "months": 3},
    {"name": "Stapler (Heavy Duty)", "category": "SUPPLIES", "quantity": 12, "location": LOC_SUPPLY_ROOM, "description": "Can staple up to 100 sheets", "access_level": "STAFF", "borrow_duration": 1, "borrow_duration_unit": "DAYS", "months": 2},
    {"name": "Staple Wire (Box)", "category": "SUPPLIES", "quantity": 30, "location": LOC_SUPPLY_ROOM, "description": "Standard 26/6 staple wire, 5000 pcs/box", "access_level": "STAFF", "is_returnable": False, "months": 2},
    {"name": "Scotch Tape (Roll)", "category": "SUPPLIES", "quantity": 50, "location": LOC_SUPPLY_ROOM, "description": "3/4 inch transparent tape", "access_level": "STUDENT", "is_returnable": False, "months": 1},
    {"name": "Masking Tape (Roll)", "category": "SUPPLIES", "quantity": 30, "location": LOC_SUPPLY_ROOM, "description": "1 inch painters tape", "access_level": "STUDENT", "is_returnable": False, "months": 1},
    {"name": "Manila Paper (Pack)", "category": "SUPPLIES", "quantity": 25, "location": LOC_SUPPLY_ROOM, "description": "20x30 inch, 10 sheets per pack", "access_level": "STUDENT", "is_returnable": False, "months": 0},
    {"name": "Cartolina (Assorted)", "category": "SUPPLIES", "quantity": 40, "location": LOC_SUPPLY_ROOM, "description": "Assorted colors, 20x30 inch", "access_level": "STUDENT", "is_returnable": False, "months": 0},
    {"name": "Folder (Brown, Legal)", "category": "SUPPLIES", "quantity": 100, "location": LOC_SUPPLY_ROOM, "description": "Kraft brown folder for filing", "access_level": "STAFF", "is_returnable": False, "months": 4},
    {"name": "Envelope (Long, Brown)", "category": "SUPPLIES", "quantity": 200, "location": LOC_SUPPLY_ROOM, "description": "Standard mailing envelope", "access_level": "STAFF", "is_returnable": False, "months": 3},
    {"name": "Ballpen (Box of 50)", "category": "SUPPLIES", "quantity": 10, "location": LOC_SUPPLY_ROOM, "description": "Blue ballpoint pen, 0.7mm", "access_level": "STAFF", "is_returnable": False, "months": 2},
    {"name": "Whiteboard Eraser", "category": "SUPPLIES", "quantity": 20, "location": LOC_FACULTY_ROOM, "description": "Magnetic whiteboard eraser", "access_level": "FACULTY", "is_returnable": True, "borrow_duration": 4, "borrow_duration_unit": "HOURS", "months": 1},
    {"name": "Glue Stick (Pack of 12)", "category": "SUPPLIES", "quantity": 15, "location": LOC_SUPPLY_ROOM, "description": "Non-toxic washable glue stick", "access_level": "STUDENT", "is_returnable": False, "months": 0},
    {"name": "Scissors (Pair)", "category": "SUPPLIES", "quantity": 20, "location": LOC_SUPPLY_ROOM, "description": "8-inch stainless steel scissors", "access_level": "STUDENT", "borrow_duration": 2, "borrow_duration_unit": "HOURS", "months": 1},
    {"name": "Correction Tape (Box)", "category": "SUPPLIES", "quantity": 24, "location": LOC_SUPPLY_ROOM, "description": "5mm x 6m correction tape, 12 pcs/box", "access_level": "STUDENT", "is_returnable": False, "months": 0},
